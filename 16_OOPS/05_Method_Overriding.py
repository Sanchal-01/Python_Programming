# Method Overriding is a feature of inheritance in which a child class provides its own implementation of a method that is already defined in the parent class.
...
# 1. __init__()
# 2. speak()
# 3. Location   ...... from Animal class automatically.
